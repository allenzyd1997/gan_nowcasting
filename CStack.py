...
class conditioningStack(nn.Module):
    ...
    def __init__(self, in_channels):
        ...
        # self.conv3_1 = SpectralNorm(nn.Conv2d(240, 48, 3,stride=1,padding=1))#图像大小保持不变
...
if __name__ == "__main__":
    ...
    # x=torch.randn(2,4,1,256,256)
    x=torch.randn(1,10,1,256,256)
    a = x[:,2,:,:,:]
    print(a.shape)
    out=cds_net(x)
    out.reverse()
